...
#应用标题
st.title('A machine learning-based predictive model for predicting distal metastasis in patients with renal cancer')
...
features = ['Age','Grade','T','N','Tumor Size']
target = 'M'
#处理数据不平衡
...
sp = 0.5
#figure
is_t = (XGB.predict_proba(np.array([[Age,Grade,T,N,Tumor_Size]]))[0][1])> sp
prob = (XGB.predict_proba(np.array([[Age,Grade,T,N,Tumor_Size]]))[0][1])*1000//1/10
